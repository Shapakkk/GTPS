...
// import { ConfirmClearWorld } from "./ConfirmClearWorld"; // <--- INI KITA HAPUS
...
// IMPORT DARI FILE COMMAND YANG BARU
import { ConfirmClearWorld } from "../../command/cmds/ClearWorld";
...
> = {
  ...
  ["confirm_clearworld"]: ConfirmClearWorld, // Tetap dipanggil di sini
  ["door_edit"]:          DoorEdit,
  ["drop_end"]:           DropEnd,
  ["sign_edit"]:          SignEdit,
  ["trash_end"]:          TrashEnd,
